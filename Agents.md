...
- don't use "any" type of typescript and always use proper types, never escape the eslint rules and always make sure to fix lint and types issues at the end of a given task!
